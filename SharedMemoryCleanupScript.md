This script should no longer be needed with recent versions of mod\_pagespeed.

```
#!/bin/sh

# See http://carlosrivero.com/fix-apache---no-space-left-on-device-couldnt-create-accept-lock
#
...
#
#   sudo ./apache_cleanup www-data
# or
#   sudo ./apache_cleanup root
